...
const Header = (props) => {
    return (
        <div className='lg:fixed h-screen basis-1.5/4 flex flex-col justify-between pb-48 self-center lg:self-auto'>
            <div className=''>
                <h1 className='text-5xl subpixel-antialiased tracking-wide'>{props.data.first_name}</h1>
                <h1 className='text-5xl subpixel-antialiased tracking-wide'>{props.data.last_name}</h1>
